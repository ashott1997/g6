...
/* harmony import */ var _b2b_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./b2b.js */ "./src/js/b2b.js");
...
openBurger.addEventListener('click', function () {
  burgerMenu.classList.add('active-burger-menu'); // html.style.overflowY = 'hidden'
});
...
if (document.querySelector('.b2b-form')) {
  var form = document.querySelector('.b2b-form');
  var button = document.querySelector('.b2b-form .btn');
  var link = form.getAttribute('link-to');
  button.addEventListener('click', function () {
    var allForms = form.querySelectorAll('.form-control');
    var checker = true;
    ...
    if (checker == true) {
      axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(link, {
